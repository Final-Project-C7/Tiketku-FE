...
export default function Footer() {
  ...
  return (
    <div>
      ...
      >
        <Modal.Body className="modal-body-team" style={{ padding: "30px" }}>
          <div className="responsive-container-block outer-container">
            <div className="responsive-container-block inner-container">
              ...
              <div className="responsive-container-block">
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">
                    <div className="img-wrapper">
                      <img className="team-img" src="ferdi.jpeg" />
                    </div>
                    ...
                    <div className="social-media-links">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        <img src="linked2.png" style={{ width: "25px" }} />
                      </a>
                    </div>
                  </div>
                </div>
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 2 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="narrizzy.jpg" />
                  </div>
                ...
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 3 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="arfin.jpg" />
                  </div>
                  <p className="text-blk name">Arfin Dwi Cahyono</p>
                ...
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 4 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="wira.jpg" />
                  </div>
                  ...
                  >
                    ...
                    <a
                      href="https://www.instagram.com/_adikurniawan__/"
                      target="_blank"
                    >
                      <img src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/gray-insta.svg" />
                    </a>
                ...
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 3 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="ratih.jpeg" />
                  </div>
                ...
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 3 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="riza.jpg" />
                  </div>
                ...
                <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                  <div className="team-card">{/* Konten Kartu Tim 3 */}</div>
                  <div className="img-wrapper">
                    <img className="team-img" src="yunis.jpeg" />
                  </div>
