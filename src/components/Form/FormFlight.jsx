...
const FormFlight = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(`https://c7-tiketku.up.railway.app/api/v1/flight/search/${depart}/${arrive}`);
          ...
          <div className="row mt-4">
            <div className="card-destination col-12 d-flex flex-wrap mb-3 mx-4">
              <div className="col-md-6 d-flex">
                ...
                <ModalFlightFrom departure={depart} setDeparture={setDepart} recentSearches={recentSearches} />
              </div>
              ...
              <div className="col-md-5 col-xl-6 d-flex me-md-3 me-xl-0">
                ...
                <div className="col-8 d-flex ms-1 ms-sm-4">
                  <div className="col-md-5 col-xl-6 ms-4 ms-md-3">
                    ...
                    <input className="card-date__input col-12 border-0 border-bottom pb-3 mt-1" value={`${format(range[0].startDate, "MM/dd/yyyy")} `} readOnly onClick={() => setOpen((open) => !open)} />
                  </div>
                  ...
                  <div className="col-md-5 col-xl-6 ms-3 ms-sm-4 ms-md-4">
                    ...
                    <input
                      className={`card-date__input ${isChecked ? "" : "card-date__disabled fw-bold"} col-12 border-0 border-bottom bg-transparent pb-3 mt-1`}
                      value={`${isChecked ? `${format(range[0].endDate, "MM/dd/yyyy")}` : "Pilih Tanggal"} `}
