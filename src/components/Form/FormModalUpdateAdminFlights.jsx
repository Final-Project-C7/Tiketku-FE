...
function FormModalUpdateAdminFlights(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.put(`https://c7-tiketku.up.railway.app/api/v1/flight/${props.data.id}`, {
        airline_id,
        admin_id,
        flight_code,
        departure,
        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number" placeholder="1" autoFocus value={airline_id} onChange={(e) => setAirlineId(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Admin ID</Form.Label>
              <Form.Control type="number" placeholder="112" value={admin_id} onChange={(e) => setAdminId(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Flight Code</Form.Label>
              <Form.Control type="text" placeholder="1" value={flight_code} onChange={(e) => setFlightCode(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Departure</Form.Label>
              <Form.Control type="number" placeholder="1" value={departure} onChange={(e) => setDeparture(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Arrival</Form.Label>
              <Form.Control type="number" placeholder="1" value={arrival} onChange={(e) => setArrival(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Seat Id</Form.Label>
              <Form.Control type="number" placeholder="1" value={seat_id} onChange={(e) => setSeatId(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Economy Class Price</Form.Label>
              <Form.Control type="number" placeholder="250000" value={economyClass_price} onChange={(e) => setEconomyClassPrice(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Premium Economy Price</Form.Label>
              <Form.Control type="number" placeholder="350000" value={premiumEconomy_price} onChange={(e) => setPremiumClassPrice(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Business Price</Form.Label>
              <Form.Control type="number" placeholder="450000" value={business_price} onChange={(e) => setBusinessPrice(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>FirstClass Price</Form.Label>
              <Form.Control type="number" placeholder="550000" value={firstClass_price} onChange={(e) => setFirstClassPrice(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Departure Time</Form.Label>
              <Form.Control type="date" value={departure_time} onChange={(e) => setDepartureTime(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Arrival Time</Form.Label>
              <Form.Control type="date" value={arrival_time} onChange={(e) => setArrivalTime(e.target.value)} />
            </Form.Group>
          </Modal.Body>
          <Modal.Footer>
