  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        const response = await axios.get(`https://c7-tiketku.up.railway.app/api/v1/bookings/${bookingId}`, { headers });
        ...
        <div className="row d-flex my-5">
          <div className="payment-booking-code col-6 mt-5 mt-md-0">
            ...
            <div className="d-flex align-items-center">
              <h5 className="fw-bold me-auto mb-0">{Moment(location?.state?.state?.departure_time).format("HH:mm")}</h5>
            ...
            <p className="fw-medium mb-0">{location?.state?.state?.departureAirport.airport_name}</p>
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="col-12">
                <p className="fw-bold mb-0">
                  {location?.state?.state?.airline.airline_name} - {selectedClass}
                </p>
          ...
          <Form onSubmit={handleSubmit}>
            <Button className="checkout-biodata__btn-2 border-0 d-flex align-items-center justify-content-center mt-4 py-4" type="submit">
              Bayar
            </Button>
