...
function AdminAirlines() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://c7-tiketku.up.railway.app/api/v1/airline/${deleteAirlineId}`);
      setIsDeleted(true);
              ...
              <div className="container p-4">
                ...
                <div>
                  ...
                  <table className="table table-striped-columns">
                    ...
                    <tbody>
                      {data?.data?.airlinesData.map((airline, index) => (
                        <tr key={airline.id}>
                          <td>{index + 1}</td>
                          <td>{airline.airline_name}</td>
                          <td>{airline.baggage}</td>
                          <td>{airline.cabin_baggage}</td>
                          <td>
                            <div className="d-flex">
                              <FormModalUpdateAdminAirlines data={airline} />
