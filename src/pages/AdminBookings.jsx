...
import FormModalUpdateAdminBookings from "../components/Form/FormModalUpdateAdminBookings";
...
function AdminBookings() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://c7-tiketku.up.railway.app/api/v1/bookings/${deleteBookingId}`, { headers });
      setIsDeleted(true);
          ...
          <div className="d-flex">
            ...
            <div className="col-10">
              ...
              <div className="container p-4">
                ...
                <div>
                  <h4 className="mb-4">Bookings List</h4>
                  <FormModalAdminBookings />
                    ...
                    <tbody>
                      {data?.data?.bookings.map((booking, index) => (
                        <tr key={booking.id}>
                          ...
                          <td>
                            <div className="d-flex">
                              <FormModalUpdateAdminBookings data={booking} />
                              <Button className="btn-danger d-flex py-1 px-3 ms-1" onClick={() => handleShow(booking.id)}>
          ...
          <Modal show={showModal} onHide={handleClose} centered>
            ...
            <Modal.Body>
              <div className="text-center">
                ...
                />
                <p className="mb-0">Are you sure you want to delete this booking?</p>
              </div>
            </Modal.Body>
            <Modal.Footer>
