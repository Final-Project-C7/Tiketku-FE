...
import FormModalAdminPassengers from "../components/Form/FormModalAdminPassengers";
...
function AdminPassengers() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`http://localhost:8000/api/v1/passengers/${deletePassengerId}`, { headers });
      setIsDeleted(true);
      ...
      <div className="d-flex">
          ...
          <div className="mt-3">
            ...
            <Link to="/admin-passengers" className="text-decoration-none">
              <div className="side-bar-admin__list side-bar-admin__selected d-flex align-items-center py-3 px-4 mb-1">
                <Image className="side-bar-admin__icon" src="passengers-icon.svg" style={{ filter: "invert(100%) sepia(0%) saturate(0%) hue-rotate(325deg) brightness(104%) contrast(101%)" }} />
        ...
        <div className="col-10">
          <Navbar.Collapse className="navbar-admin Container d-flex p-4">
            <h4 className="me-auto mb-0">Passengers</h4>
            <Dropdown>
          ...
          <div className="container p-4">
            ...
            <div>
              <h4 className="mb-4">Passengers List</h4>
              <FormModalAdminPassengers />
                ...
                <tbody>
                  {data?.data?.passengers.map((passenger, index) => (
                    <tr key={passenger.id}>
                      ...
                      <td>{passenger.born_date}</td>
                      <td>{passenger.citizen}</td>
                      <td>{passenger.identity_number}</td>
                      <td>{passenger.publisher_country}</td>
                      <td>{passenger.valid_until}</td>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <Button className="btn-danger d-flex py-1 px-3 ms-1" onClick={() => handleShow(passenger.id)}>
      ...
      <Modal show={showModal} onHide={handleClose} centered>
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <p className="mb-0">Are you sure you want to delete this passenger?</p>
          </div>
        </Modal.Body>
        <Modal.Footer>
