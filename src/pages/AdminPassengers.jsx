...
import FormModalUpdateAdminPassengers from "../components/Form/FormModalUpdateAdminPassengers";
...
function AdminPassengers() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://c7-tiketku.up.railway.app/api/v1/passengers/${deletePassengerId}`, { headers });
      setIsDeleted(true);
                    ...
                    <tbody>
                      {data?.data?.passengers.map((passenger, index) => (
                        <tr key={passenger.id}>
                          ...
                          <td>
                            <div className="d-flex">
                              <FormModalUpdateAdminPassengers data={passenger} />
