...
function AdminPayments() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`http://localhost:8000/api/v1/payments/${deletePaymentId}`, { headers });
      setIsDeleted(true);
              ...
              <div className="mt-3">
                ...
                <Link to="/admin-payments" className="text-decoration-none">
                  <div className="side-bar-admin__list side-bar-admin__selected d-flex align-items-center py-3 px-4 mb-1">
                    <Image className="side-bar-admin__icon" src="payment-icon.svg" style={{ filter: "invert(100%) sepia(0%) saturate(0%) hue-rotate(325deg) brightness(104%) contrast(101%)" }} />
                        ...
                        <tr key={payment.id}>
                          ...
                          <td>
                            <div className="d-flex">
                              ...
                              <Button className="btn-danger d-flex py-1 px-3 ms-1" onClick={() => handleShow(payment.id)}>
          ...
          <Modal show={showModal} onHide={handleClose} centered>
            ...
            <Modal.Body>
              <div className="text-center">
                ...
                <p className="mb-0">Are you sure you want to delete this payment?</p>
              </div>
            </Modal.Body>
            <Modal.Footer>
