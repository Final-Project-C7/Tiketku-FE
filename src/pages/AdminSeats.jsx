...
import FormModalUpdateAdminSeats from "../components/Form/FormModalUpdateAdminSeats";
...
function AdminSeats() {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`http://localhost:8000/api/v1/seats/${deleteSeatId}`, {
        headers,
      });
      setIsDeleted(true);
                    ...
                    <tbody>
                      {data?.data?.seats?.map((seat, index) => (
                        <tr key={seat.id}>
                          ...
                          <td>
                            <div className="d-flex">
                              <FormModalUpdateAdminSeats data={seat} />
                              <Button
                                className="btn-danger d-flex py-1 px-3 ms-1"
                                onClick={() => handleShow(seat.id)}
                              >
                                <Image
