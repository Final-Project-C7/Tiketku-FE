              ...
              <div className="mt-3">
                ...
                <Link to="/admin-users" className="text-decoration-none">
                  <div className="side-bar-admin__list side-bar-admin__selected d-flex align-items-center py-3 px-4 mb-1">
                    <Image className="side-bar-admin__icon" src="users-icon.svg" style={{ filter: "invert(100%) sepia(0%) saturate(0%) hue-rotate(325deg) brightness(104%) contrast(101%)" }} />
                        ...
                        <tr key={user.id}>
                          ...
                          <td>
                            <div className="d-flex">
                              ...
                              <Button className="btn-danger d-flex py-1 px-3 ms-1" onClick={() => handleShow(user.id)}>
